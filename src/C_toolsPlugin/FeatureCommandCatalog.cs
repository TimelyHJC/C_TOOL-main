...
internal static class FeatureCommandCatalog
{
    private static readonly CommandEntry[] s_entries =
    {
        ...
        VisibleRibbon(PluginCommandIds.RectangleMerge, "矩形合并", "将多个矩形合并为一个闭合图形", C_toolsCommandIds.MainToolset.Main),
        ...
        VisibleRibbon(C_toolsCommandIds.Ddd.TextToMText, "单转多", "文字工具：启动 AutoCAD 原生 TXT2MTXT，将单行文字转换为多行文字；支持先选文字再执行命令", C_toolsCommandIds.Ddd.Main),
        Hidden(C_toolsCommandIds.Ddd.TextToMTextCompat),
        ...
        VisibleRibbon(C_toolsCommandIds.Ddd.TextMatch, "匹配文字", "文字工具：选择来源文字对象后，点选目标文字即可直接匹配为来源内容；支持预选目标", C_toolsCommandIds.Ddd.Main),
